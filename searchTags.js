export function searchTags()
{
   ...
   $divtags.appendChild($tblplanillas );
   const $styles = document.getElementById("dinamic-style");
   
   $divtags.id = "divplanilla";
   $styles.innerHTML = `
...
.button:active {
  ...
  Parametros de parametros
   ...
   <p>
   <label for="noId">No.Tag</label><br>
    ...
    function getQuery(query) {
        ...
        var car="";
          ...
          function Validate()
          {
           if ((document.getElementById("txtnumId").value==""
               ...
               {
               alert("Introduzca  el No. Tag y/o COMODIN (*)");
      ...
      switch(e.target.id) {
        ...
        console.log ("search tags");
              ...
              console.log("searchTags?numId="+txtnumId.value+"&comodin="+comodin.value);
              getQuery("searchTags?numId="+txtnumId.value+"&comodin="+comodin.value);
            }
              break;
          case 'comodin':
