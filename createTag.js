...
.button:active {
  ...
  transform: translateY(4px);
   ...
   <p><label for="txtnumtag" >No. tag: </label>
     <input type="text" id="txtnumtag"  size="20">
   </p>
   </div>
    ...
    function getQuery(query) {
      ...
      Http.open("GET", query);
        ...
        Http.onreadystatechange = (e) => {
          ...
          function Validate()
          {
           if ((document.getElementById("txtnumtag").value==""
               || document.getElementById("txtnumtag").value== null)
              )
               {
               alert("Introduzca  el No. TAG");
    ...
    document.addEventListener('click' ,function(e) {
      switch(e.target.id) {
        ...
        case 'btnCreatePlanilla':
              ...
              //createTable();txtnumtag
            
              getQuery("createTag?numTag="+txtnumtag.value+"&estado=0"); 
            }
              break;
